  ...
  return (
    <main
      style={{
        ...
        background: "linear-gradient(145deg, var(--pink-wash) 0%, #fff 50%, var(--pink-wash) 100%)",
        position: "relative",
        overflow: "hidden",
      }}
    >
      ...
      <div style={{ width: "100%", maxWidth: "480px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.85)", backdropFilter: "blur(20px)", borderRadius: "2rem", border: "1px solid rgba(230, 79, 85,0.1)", boxShadow: "0 8px 48px rgba(230, 79, 85,0.08), 0 0 0 1px rgba(255,255,255,0.8)", padding: "clamp(2rem, 5vw, 3rem)" }}>
          ...
          <p style={{ fontSize: "0.62rem", fontWeight: 800, letterSpacing: "0.3em", textTransform: "uppercase", color: "var(--pink-deep)", marginBottom: "0.6rem" }}>
            Recuperar acceso
          </p>
